    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        ui.collapsing("Drop Shadow", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                egui::ComboBox::from_id_salt("ds_blend")
                    ...
                    .show_ui(ui, |ui| {
                        if ui.selectable_value(&mut blend_idx, 0, "Normal").clicked() {
                            changed = true;
                        }
                        if ui.selectable_value(&mut blend_idx, 1, "Multiply").clicked() {
                            changed = true;
                        }
                        if ui.selectable_value(&mut blend_idx, 2, "Screen").clicked() {
                            changed = true;
                        }
                        if ui.selectable_value(&mut blend_idx, 3, "Overlay").clicked() {
                            changed = true;
                        }
                        if ui.selectable_value(&mut blend_idx, 4, "Add").clicked() {
                            changed = true;
                        }
                    });
            });
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut style.drop_shadow.opacity, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::Slider::new(&mut style.drop_shadow.angle, -180.0..=180.0).suffix("°"),
                    )
                    .changed()
                {
                    changed = true;
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(
                        egui::Slider::new(&mut style.drop_shadow.distance, 0.0..=200.0)
                            .suffix(" px"),
                    )
                    .changed()
                {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut style.drop_shadow.size, 0.0..=200.0).suffix(" px"))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Inner Shadow", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut s.opacity, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut s.angle, -180.0..=180.0).suffix("°"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut s.distance, 0.0..=250.0))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Outer Glow", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut style.outer_glow.opacity, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ui.label(
                    egui::RichText::new("Spread")
                        .small()
                        .color(colors::TEXT_SECONDARY),
                );
                if ui
                    .add(egui::Slider::new(&mut style.outer_glow.spread, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut style.outer_glow.size, 0.0..=200.0).suffix(" px"))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Inner Glow", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut ig.opacity, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut ig.size, 0.0..=64.0))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Satin", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut s.distance, 0.0..=150.0))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Bevel / Emboss", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut bv.angle, -180.0..=180.0).suffix("°"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut bv.depth, 1.0..=20.0))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut bv.size, 0.0..=64.0))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut bv.highlight, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ui.label(
                    egui::RichText::new("Shadow")
                        .small()
                        .color(colors::TEXT_SECONDARY),
                );
                if ui
                    .add(egui::Slider::new(&mut bv.shadow, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Stroke", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut style.stroke.size, 1.0..=250.0).suffix(" px"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                egui::ComboBox::from_id_salt("stroke_pos")
                    ...
                    .show_ui(ui, |ui| {
                        if ui
                            .selectable_value(&mut style.stroke.position, 0, "Outside")
                            .clicked()
                        {
                            changed = true;
                        }
                        if ui
                            .selectable_value(&mut style.stroke.position, 1, "Inside")
                            .clicked()
                        {
                            changed = true;
                        }
                        if ui
                            .selectable_value(&mut style.stroke.position, 2, "Center")
                            .clicked()
                        {
                            changed = true;
                        }
        ...
        ui.collapsing("Gradient Overlay", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut go.opacity, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut go.angle, -180.0..=180.0).suffix("°"))
                    .changed()
                {
                    changed = true;
                }
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut go.scale, 10.0..=400.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
        ...
        ui.collapsing("Color Overlay", |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add(egui::Slider::new(&mut co.opacity, 0.0..=100.0).suffix("%"))
                    .changed()
                {
                    changed = true;
                }
